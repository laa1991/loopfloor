...
| 两侧判据 | **two-sided criterion** | 正对照**必须开火**且负对照**必须沉默**；只跑过一侧的判据还不算立住（见 `docs/05`） |
| 正对照 | **positive control** | 拿一份**确知有病**的材料喂尺：它不该沉默 |
| 负对照 | **negative control** | 拿一份**确知没病**的材料喂尺：它不该开火（不误报） |
